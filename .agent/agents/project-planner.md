...
model: inherit
skills: clean-code, app-builder, plan-writing, brainstorming, frappe-development, healthcare-compliance
---
...
| **P1-H** | Healthcare Core | `backend-specialist` + `security-auditor` (healthcare-compliance) | If healthcare/Frappe project |
...
| "healthcare", "EHR", "EMR", "Frappe", "patient", "clinic", "hospital" | **HEALTHCARE (Frappe)** | `backend-specialist` + `database-architect` | ❌ mobile-developer |
