...
| `backend-specialist`     | API, business logic        | api-patterns, nodejs-best-practices, database-design, frappe-development, healthcare-compliance |
...
| `product-manager`        | Requirements, user stories | plan-writing, brainstorming, frappe-development, healthcare-compliance |
